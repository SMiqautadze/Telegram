...
@api_router.post("/scrape/{channel_id}")
...
@api_router.get("/channel-data/{channel_id}")
...
@api_router.get("/export-data/{channel_id}/{format}")
...
@api_router.post("/continuous-scrape/start")
...
@api_router.post("/continuous-scrape/stop")
